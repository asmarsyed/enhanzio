...
export default function Navbar() {
  ...
  // Gérer la fermeture de la sidebar lorsque vous cliquez en dehors d'elle
  const handleOutsideClick = useCallback((event: MouseEvent) => {
    const sidebarElement = document.querySelector('#default-sidebar');
    if (sidebarElement && isSidebarOpen && !sidebarElement.contains(event.target as Node)) {
      setIsSidebarOpen(false);
    }
  }, [isSidebarOpen]);

  // Ajouter un gestionnaire d'événement pour les clics sur le document
  useEffect(() => {
...
return (
    <div>
        <button onClick={handleSidebarClick} data-drawer-target="default-sidebar" data-drawer-toggle="default-sidebar" aria-controls="default-sidebar" type="button" className="fixed top-16 left-2 p-2 text-sm text-gray-500 rounded-lg hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600">
        ...
        <aside id="default-sidebar" className={`fixed top-12 left-0 z-40 w-64 h-screen transition-transform ${isSidebarOpen ? '' : '-translate-x-full'}`} aria-label="Sidenav">
  <div className="overflow-y-auto py-5 px-3 h-full bg-white border-gray-200 dark:bg-gray-800 dark:border-gray-700">
      <ul className="space-y-2">
          <li>
              <a href="/planning" className="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
              <svg className="w-6 h-5 text-gray-400 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 20">
          ...
          <li>
              <a href="/dashboard" className="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
          ...
          <li>
              <button onClick={handleDivClick} type="button" className="flex items-center p-2 w-full text-base font-normal text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700" aria-controls="dropdown-pages" data-collapse-toggle="dropdown-pages">
                  ...
                  <span className="flex-1 ml-3 text-left whitespace-nowrap">DMAIC</span>
              ...
              <ul id="dropdown-pages" className={`py-2 space-y-2 ${isDivClicked ? 'hidden' : ''}`}>

                  <li>
                      <a href="/define" className="flex items-center p-2 pl-11 w-full text-base font-normal text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Define</a>
                  </li>
                  <li>
                      <a href="/measure" className="flex items-center p-2 pl-11 w-full text-base font-normal text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Measure</a>
                  </li>
                  <li>
                      <a href="/analyze" className="flex items-center p-2 pl-11 w-full text-base font-normal text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Analyze</a>
                  </li>
                  <li>
                      <a href="/improve" className="flex items-center p-2 pl-11 w-full text-base font-normal text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Improve</a>
                  </li>
                  <li>
                      <a href="/control" className="flex items-center p-2 pl-11 w-full text-base font-normal text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Control</a>
                  </li>
              </ul>
          </li>
          <li>
              <a href="/pricing" className="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg transition duration-75 hover:bg-gray-100 dark:hover:bg-gray-700 dark:text-white group">
              <svg className="w-6 h-6 text-gray-400 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 16">
