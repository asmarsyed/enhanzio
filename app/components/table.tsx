      ...
      <div className="bg-[white] rounded-md mt-4 border">
        <table className="w-full">
          <thead className="bg-[#F3F7FC]">
            <th className="w-[30%] text-left py-4 px-6 rounded-tl-md">Name</th>
            <th className="w-[30%] text-left">Role</th>
            <th className="w-[30%] text-left">Estimated time on the project</th>
            <th className="w-[10%] text-left rounded-tr-md">Edit</th>
          </thead>
          <tbody>
            <tr>
