...
const Define = () => {
  return (
    <div className="mt-6 mx-6">
      ...
      <p className="text-gray-500 mt-4">
        1. Defining the problem : What challenge or opportunity do you seek to address? It&aposs about pinpointing the core problem that needs solving or the process that requires optimization.
      </p>
      ...
      <p className="text-gray-500 mt-4">
        4. To define the project&aposs scope, this step involves using the SIPOC tool, which stands for Supplier, Input, Process, Output, Customer.  SIPOC is a visual framework commonly used in process improvement, breaking down a process into key components for a high-level understanding.
      </p>
      ...
      <p className="text-gray-500 mt-4">
        5. Defining the business case, which involves specifying the budget and calculating the potential cost savings achievable through this project. This financial aspect clarifies the project&aposs economic impact and feasibility.
      </p>
