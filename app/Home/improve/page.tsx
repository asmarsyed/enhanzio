    ...
    <div className="mt-6 mx-6 w-full flex justify-center transition-all">
      <div className="w-full xl:w-[90%]">
        ...
        <p className="text-gray-500 mt-4">
          The &apos;Improve&apos; phase is where innovation and transformation
          come to life. Here, you develop and implement solutions, making
          tangible changes to your process to achieve better outcomes.
        </p>
        ...
        >
          <p className="text-gray-500 mt-4">6. End of phase</p>
